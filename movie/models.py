...
class FilmView(models.Model):
    ...
    current_watch_time = models.PositiveIntegerField(default=0)  # new field to track carrent watch time per_film_per_user
...
class MyFilms(models.Model):
    ...
    txn_id = models.CharField(max_length=100, blank=True, help_text="ReelBux/Stripe/PayPal TXN ID")
