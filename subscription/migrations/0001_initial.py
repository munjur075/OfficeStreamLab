    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tx_type', models.CharField(choices=[('fund', 'Add Fund'), ('transfer', 'Transfer Distro → ReelBux'), ('withdraw', 'Withdraw from Distro'), ('purchase', 'Buy Film'), ('rent', 'Rent Film'), ('commission', 'Distro Commission'), ('subscription', 'AI Subscription'), ('filmmaker_earning', 'Filmmaker Earning'), ('platform_earning', 'Platform Earning')], max_length=20)),
                ...
                ('txn_id', models.CharField(blank=True, help_text='Stripe/PayPal TXN ID', max_length=100)),
                ('paypal_token', models.CharField(blank=True, max_length=255, null=True)),
                ('description', models.TextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('film', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='movie.film')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reel_bux_balance', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
                ('distro_balance', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
